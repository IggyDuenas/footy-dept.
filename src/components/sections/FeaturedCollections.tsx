...
const collections = [
  {
    name: 'Brazil',
    tag: 'O Jogo Bonito',
    href: '/shop?type=national&country=Brazil',
    image: '/images/collections/brazil.png',
    color: 'from-yellow-900/40',
  },
  {
    name: 'France',
    tag: 'Les Bleus',
    href: '/shop?type=national&country=France',
    image: '/images/collections/france.png',
    color: 'from-blue-900/40',
  },
  {
    name: 'USA',
    tag: 'Bold & Brave',
    href: '/shop?type=national&country=USA',
    image: '/images/collections/usa.png',
